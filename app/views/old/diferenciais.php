	...
	<body>
		...
		<section id="area-internas">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12"><br/><br/><div id="areaTitulos"><h1 class="tit-categorias">Diferenciais</h1></div><br/><br/><br/><br/></div>
				</div>

				<div id="area-empresa-texto" class="row">
					<div class="col-md-12">
						<?php
						$queryConteudo = $vConexao->query("SELECT * FROM sysc_conteudo WHERE secao='assistencia'") or die ("Falha ao tentar conexão com Conteudo");
