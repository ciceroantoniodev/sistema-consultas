        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="text-align: right">
                    <a href="<?=URL?>/Office/Especialidades/Novo" class="btn btn-primary"><i class="fas fa-plus"></i> Nova Especialidade</a>
                </div>
            </div>  
            <br>
            <div class="row">
                <div class="col">
                    ...
                    if (!empty($dados)) {
                        ...
                        echo '<br><br><br><h5>Nenhuma Especialidade Cadastrado!</h5>';
