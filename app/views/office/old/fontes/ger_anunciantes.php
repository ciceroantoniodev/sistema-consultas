...
echo '<tr><td class="form-cadastros-head" colspan="7"><a href="javascript: history.go(-' . $vBotaoVoltar . ')"><div class="botao-voltar"><img src="images/botao_voltar.gif" height="30" /></div></a><div align="center">GERENCIAMENTO DE ANUNCIANTES</div></td></tr>';
echo '<tr><td class="area-grid-barra" colspan="7">';
echo '<div class="floatRIGHT"><form name="frmGridBuscar" onSubmit="return false">Buscar: <input type="text" name="formBUSCAR" size="30" class="form_buscar" /><input type="button" value="Ok!" class="botao-ok" onClick="fAjaxDirecionar(\'grid_anunciantes.php?local=' . $getLOCAL . '&tp=' . $vgetTIPO . '&idu=' . $vgetIDUSUARIO. '&&key=A\')" /></form></div>';
...
//if (strpos("ABC" . $vusuarioACESSOS, "4") > 0) {
	...
	echo '<div class="floatRIGHT"><a href="cad_anuncio.php?local=' . $getLOCAL . '&idu=' . $vgetIDUSUARIO . '&tp=' . $vgetTIPO . '" class="rodape" target="main"><div class="botao-novo">&nbsp;&nbsp;&nbsp;Novo Anúncio&nbsp;&nbsp;&nbsp;</div></a></div>';
...
<script type="text/javascript">showDIRECT("", "grid_anunciantes.php?local=<?php echo $getLOCAL ?>&idu=<?php echo $vgetIDUSUARIO ?>&tp=<?php echo $vgetTIPO ?>&key=", "areaDIRECT");</script>
