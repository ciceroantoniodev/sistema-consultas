...
echo '<tr><td class="form-cadastros-head" colspan="7"><a href="javascript: history.go(-' . $vBotaoVoltar . ')"><div class="botao-voltar"><img src="images/botao_voltar.gif" height="30" /></div></a><div align="center">GERENCIAMENTO DE VENDEDORES</div></td></tr>';
echo '<tr><td class="area-grid-barra" colspan="7">';
echo '<div class="floatRIGHT"><form name="frmGridBuscar" onSubmit="return false">Buscar: <input type="text" name="formBUSCAR" size="30" class="form_buscar" /><input type="button" value="Ok!" class="botao-ok" onClick="fAjaxDirecionar(\'grid_vendedores.php?local=' . $getLOCAL . '&r=' . $vgetROTINAS . '&tp=' . $vgetTIPO . '&idu=' . $vgetIDUSUARIO. '&&key=A\')" /></form></div>';
...
<script type="text/javascript">showDIRECT("", "grid_vendedores.php?local=<?php echo $getLOCAL ?>&idu=<?php echo $vgetIDUSUARIO ?>&r=<?php echo $vgetROTINAS ?>&tp=<?php echo $vgetTIPO ?>&key=", "areaDIRECT");</script>
