...
if ($vgetKEY != $vgetQRY) {
	...
	$dbSQL = "SELECT * FROM sysc_usuarios ORDER BY nome";
...
echo '<td align="center" class="area-grid-cabeca">NOME USUÁRIO</td>';
...
echo '<td align="center" class="area-grid-cabeca">E-MAIL</td></tr>';
