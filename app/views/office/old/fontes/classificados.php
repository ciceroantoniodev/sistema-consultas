...
echo '<tr><td class="form-cadastros-head" colspan="7"><a href="javascript: history.go(-' . $vBotaoVoltar . ')"><div class="botao-voltar"><img src="images/botao_voltar.gif" height="30" /></div></a><div align="center">CLASSIFICADOS</div></td></tr>';
...
//if (strpos("ABC" . $vusuarioACESSOS, "4") > 0) {
	echo '<div class="floatRIGHT"><a href="classificados_cadastrar.php?id=' . $vgetIDUSUARIO . '&tp=' . $vgetTIPO . '" class="rodape" target="main"><div class="botao-novo">&nbsp;&nbsp;&nbsp;Novo Cadastro&nbsp;&nbsp;&nbsp;</div></a></div>';
...
?>
<script type="text/javascript">showDIRECT("", "grid_classificados.php?id=<?php echo $vgetIDUSUARIO ?>&tp=<?php echo $vgetTIPO ?>&key=", "areaDIRECT");</script>
